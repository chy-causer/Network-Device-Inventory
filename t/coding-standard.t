...
my %testfiles = (
    ...
    "$CGIDIR/contracts-report"     => 'script',
    "$CGIDIR/edithost"             => 'script',
    "$CGIDIR/evil-frodo"           => 'script',
    "$CGIDIR/finance"              => 'script',
    "$CGIDIR/frodo"                => 'script',
    "$CGIDIR/hostname-check"       => 'script',
    "$CGIDIR/hosts"                => 'script',
    "$CGIDIR/hoststocontracts"     => 'script',
    "$CGIDIR/index"                => 'script',
    ...
    "$CGIDIR/locations-report"     => 'script',
    "$CGIDIR/manufacturers"        => 'script',
    "$CGIDIR/manufacturers-report" => 'script',
    "$CGIDIR/models"               => 'script',
    "$CGIDIR/models-hosts"         => 'script',
    "$CGIDIR/models-report"        => 'script',
    ...
    "$MODULESDIR/Inventory/HoststoContracts.pm" => 'module',
