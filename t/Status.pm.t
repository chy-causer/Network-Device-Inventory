...
#
# $Id: Status.pm.t 3523 2012-02-06 12:23:54Z guy $
# $LastChangedBy: guy $
# $LastChangedDate: 2012-02-06 12:23:54 +0000 (Mon, 06 Feb 2012) $
# $LastChangedRevision: 3523 $
# $uid: ZESjvcqkgMBzgu9Vpz0dhZYMvBT5LMKpLdVpbJsHmY4Ju $
#
 use strict;
...
# $result=`perlcritic -4 /home/networks/subversion/networks/src/local/www/inventory/lib/modules/Inventory/Status.pm`
# chomp /home/networks/subversion/networks/src/local/www/inventory/lib/modules/Inventory/Status.pm
# $exected = "/home/networks/subversion/networks/src/local/www/inventory/lib/modules/Inventory/Status.pm source OK";
# is( $result,
# $expected,
# 'The script passes percritic level 4 without issue'
# );

# $result=`perlcritic -5 /home/networks/subversion/networks/src/local/www/inventory/lib/modules/Inventory/Status.pm`
# chomp /home/networks/subversion/networks/src/local/www/inventory/lib/modules/Inventory/Status.pm
# $exected = "/home/networks/subversion/networks/src/local/www/inventory/lib/modules/Inventory/Status.pm source OK";
# is( $result,
# $expected,
